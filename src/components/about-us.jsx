          ...
          <div className="max-w-8xl w-full space-y-8">
            <div className="bg-emerald-50 shadow-md rounded-lg p-8">
              <div className="space-y-6">
                ...
                <div>
                  <h4 className=" text-gray-800">About Mindvalves</h4>
                  <p className="mt-2 text-gray-600">
                    Welcome to Mindvalves, your partner in lifelong learning.
                ...
                <div>
                  ...
                  <p className="mt-2 text-gray-600">
                    At Mindvalves, we envision a future where education knows no
                    boundaries. Through our innovative online platform, we aim
                    to democratize learning and make it accessible to anyone,
                ...
                <div>
                  ...
                  <p className="mt-2 text-gray-600">
                    When you choose Mindvalves, you're not just enrolling in a
